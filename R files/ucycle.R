...
prod<-c(59.2, 58.3, 63.4, 59.7, 58.9, 62.7, 47.6, 58.6, 64.4, 66.4, 64.2, 62.2, 61.7, 62.2, 65.5, 64.6, 64.6, 62.2, 53.2, 62.5, 68.5, 73.5, 67.1, 68.6,
...
tsprod<-ts(prod, frequency = 12, start = c(1967,1))
...
q<-bsm.cycle(tsprod, cycle.fixed = F)
a<-result(q, "ssf.smoothing.states")
plot(a[,3], type='l')

printbsm.cycle<-function(rslt){
