...
add(model, jd3_ssf_locallineartrend("tu", levelVariance = 0, fixedLevelVariance = T ))
add(model, jd3_ssf_locallineartrend("ty", levelVariance = 0, fixedLevelVariance = T))
...
add(eq3, "tpicore")
add(eq3, "cycle", .1, F, jd3_ssf_loading(4))
add(model, eq3)
